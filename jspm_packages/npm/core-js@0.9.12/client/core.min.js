...
(function(process) {
  !function(a) {
    ...
    !function(c) {
      ...
      function B(a) {
        var e = h[a] = b.set(j(f.prototype), z, a);
        return b.DESC && m && k(Object.prototype, a, {
          configurable: !0,
          set: function(b) {
            d(this, c) && d(this[c], a) && (this[c][a] = !1), k(this, a, s(1, b));
          }
        }), e;
      }
      function q(a, b, e) {
        return e && d(h, b) && (e.enumerable ? (d(a, c) && a[c][b] && (a[c][b] = !1), e = j(e, {enumerable: s(0, !1)})) : (d(a, c) || k(a, c, s(1, {})), a[c][b] = !0)), k(a, b, e);
      }
      function r(a, b) {
        E(a);
        for (var c,
      ...
      n || (f = function() {
        ...
        return this[z];
      }), b.create = t, b.setDesc = q, b.getDesc = w, b.setDescs = r, b.getNames = x, b.getSymbols = y, b.DESC && b.FW && C(Object.prototype, "propertyIsEnumerable", D, !0));
      var A = {
        "for": function(a) {
          return d(i, a += "") ? i[a] : i[a] = f(a);
        },
        keyFor: function(a) {
          return H(i, a);
        },
      ...
      b.each.call("hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), function(a) {
        var b = e(77)(a);
        A[a] = n ? b : B(b);
      }), m = !0, g(g.G + g.W, {Symbol: f}), g(g.S, "Symbol", A), g(g.S + g.F * !n, "Object", {
        create: t,
        defineProperty: q,
        defineProperties: r,
      ...
      }), p(f, "Symbol"), p(Math, "Math", !0), p(b.g.JSON, "JSON", !0);
    }, function(c, d, a) {
      var b = a(65);
      ...
      var b = a(64),
          c = {};
      c[a(77)("toStringTag")] = "z", a(62).FW && "z" != b(c) && a(73)(Object.prototype, "toString", function() {
      ...
      }), b.prototype = g, g.constructor = b, f(73)(a.g, i, b));
    }, function(i, j, b) {
      function c(a) {
      ...
      }), f.constructor = b, b.prototype = f, d(73)(c.g, "RegExp", b)), "g" != /./g.flags && c.setDesc(f, "flags", {
        configurable: !0,
        get: d(71)(/^.*\/(\w*)$/, "$1")
      })), d(87)(b);
    }, function(D, C, c) {
 ...
 while (!g(d, c = e[b.i++]));
        ...
        return function(i, d) {
          ...
          if (arguments.length < 2)
            for (; ; ) {
              ...
              b += h, g(a ? b >= 0 : e > b, "Reduce of empty array with no initial value");
            }
          for (; a ? b >= 0 : e > b; b += h)
            b in c && (d = i(d, c[b], b, this));
          return d;
        };
      }
      function e(a) {
      ...
      if (!b.DESC) {
        ...
        b.setDesc = function(b, c, a) {
          ...
          return "value" in a && (r(b)[c] = a.value), b;
        }, b.getDesc = function(c, d) {
          if (t)
            try {
              return N(c, d);
            } catch (e) {}
          return j(c, d) ? b.desc(!z.propertyIsEnumerable.call(c, d), c[d]) : a;
      ...
      var m = "constructor,hasOwnProperty,isPrototypeOf,propertyIsEnumerable,toLocaleString,toString,valueOf".split(","),
          ...
          k = function() {
            var a,
                ...
                c = H,
                d = ">";
            for (b.style.display = "none", o.appendChild(b), b.src = "javascript:", a = b.contentWindow.document, a.open(), a.write("<script>document.F=Object</script" + d), a.close(), k = a.F; c--; )
              delete k.prototype[m[c]];
            return k();
          };
      c(c.S, "Object", {
        getPrototypeOf: b.getProto = b.getProto || function(a) {
          return a = Object(g.def(a)), j(a, n) ? a[n] : u(a.constructor) && a instanceof a.constructor ? a.constructor.prototype : a instanceof Object ? z : null;
        },
        getOwnPropertyNames: b.getNames = b.getNames || F(G, G.length, !0),
        create: b.create = b.create || function(c, d) {
          var b;
          return null !== c ? (p.prototype = r(c), b = new p, p.prototype = null, b[n] = c) : b = k(), d === a ? b : q(b, d);
        },
        keys: b.getKeys = b.getKeys || F(m, H, !1),
        seal: b.it,
        freeze: b.it,
        ...
        isExtensible: b.isObject
          ...
          function c() {
            var h = e.concat(l.call(arguments)),
                f = this instanceof c,
      ...
      c(c.P + c.F * E, "Array", {slice: function(g, b) {
          var d = f(this.length),
              i = h(this);
          if (b = b === a ? d : b, "Array" == i)
            return l.call(this, g, b);
          for (var e = B(g, d),
              m = B(b, d),
              j = f(m - e),
              k = Array(j),
          ...
          return Q.apply(b.ES5Object(this), arguments);
      ...
      var v = new Date(-5e13 - 1),
          O = !(v.toISOString && "0385-07-25T07:06:39.999Z" == v.toISOString() && d(72)(function() {
      ...
      c(c.P + c.F * O, "Date", {toISOString: function() {
        ...
        var b = C(a);
        return "Object" == b && u(a.callee) ? "Arguments" : b;
      });
    }, function(e, f, a) {
      var c = a(62),
          b = a(65),
      ...
      var e = 0;
      b.safe = d(62).g.Symbol || b, c.exports = b;
    }, function(c, e, d) {
      function a(c, a, b) {
        if (!c)
      ...
      f.exports = function(j, u, t, l, n) {
        ...
        if (c.isFunction(f) && (n || !g && k.forEach && k.entries)) {
          ...
          f = t.getConstructor(j, l, m), b(93)(f.prototype, u);
